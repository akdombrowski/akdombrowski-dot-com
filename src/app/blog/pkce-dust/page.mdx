...
{/**
  ...
  */}
<BlogImg src="/PKCE-attack-graphic-blog.webp" containerStyles={{aspectRatio: 700 / 314, backgroundColor: "#FFF"}} style={{objectFit: "contain"}} fill />
...
[^url]: [https://pingidentity.com/en/resources/blog/post/pkce-dust-securing-your-oauth-2-0-authorization-code-grant-type.html](https://pingidentity.com/en/resources/blog/post/pkce-dust-securing-your-oauth-2-0-authorization-code-grant-type.html)
